...
sed -i "/export CNV_USERDATA_SCRIPT_PATH=/d" $CONFIG_FILE
echo "export CNV_AMI_ID=\"$(cat image.id)\"" >> $CONFIG_FILE
echo "export CNV_SEC_GROUP_ID=\"$AWS_SECURITY_GROUP\"" >> $CONFIG_FILE
echo "export CNV_USERDATA_SCRIPT_PATH=\"/home/ec2-user/webserver-userdata.sh\"" >> $CONFIG_FILE
...
echo " http://$MASTER_PUBLIC_DNS:8000/fractals?w=400&h=400&iterations=100"
echo " "
