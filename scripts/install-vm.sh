...
# Install Web Server and Javassist and config.sh
...
scp -o StrictHostKeyChecking=no -i "$AWS_EC2_SSH_KEYPAR_PATH" "$DIR/config.sh" ec2-user@"$REMOTE_HOST":/home/ec2-user/
